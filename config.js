...
module.exports = {
    ...
    WARNCOUND : process.env.WARNCOUND || "2", // to kick a person by war cound
    GROUP_CHAT : process.env.GROUP_CHAT || 'false', // to set chat bot on grp
    FREE_TXT : process.env.FREE_TXT || 'dominic',//nothing😉
    ...
    MENSION: {
        ...
        MENSION_TEXT : process.env.MENSION_TEXT || '𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙼𝙳 𝙱𝙾𝚃,𝙳𝙾𝙼𝙸𝙽𝙸𝙲🦋,https://chat.whatsapp.com/GNWB7BgMduoDij7a64qux4'
    },
    ...
    PROFILE_STATUS : process.env.PROFILE_STATUS || "💗 ᴀᴜᴛᴏ ᴍᴀᴛɪᴄ ʙɪᴏ ʙy ᴰᴼᴹᴵᴻᴵᴄ-ʙᴏᴛ-ᴍᴅ",// profile status updating value
    HEROKU: {
    ...
    AUDIO_DATA : process.env.AUDIO_DATA || "Dominic, 💗,https://i.imgur.com/DyLAuEh.jpg",//audio metadata
    STICKER_DATA: process.env.STICKER_DATA || "ᴰᴼᴹᴵᴻᴵᴄ, 🦋,https://i.imgur.com/DyLAuEh.jpg",//sticker metedata
    INSTAGRAM : process.env.INSTAGRAM || "https://chat.whatsapp.com/GNWB7BgMduoDij7a64qux4",//your ig url
    PACKNAME : process.env.PACKNAME || "ᴰᴼᴹᴵᴻᴵᴄ-ʙᴏᴛ",// packname 
    GIT : process.env.GIT || "https://api.whatsapp.com",//github url
    WEB : process.env.WEB || "",//your website url
    YT : process.env.YT || "",//your yt url
    CAPTION : process.env.CAPTION || "_created by Dominic_",//captions of img and videos
    ...
    WAGRP : process.env.WAGRP || 'https://api.whatsapp.com/send/?phone=918593074023&text&type=phone_number&app_absent=0',//your wa group url
    };
